...
<section class="single-post spad">
    <div class="single-post__hero set-bg" data-setbg="{{ asset('assets') }}/img/categories/single-post/single-post-hero.jpg"></div>
    <div class="container">
                ...
                <div class="single-post__more__details">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <img src="{{ asset('assets') }}/img/categories/single-post/single-post-desc.jpg" alt="">
                        </div>
                        <div class="col-lg-6 col-md-6">
