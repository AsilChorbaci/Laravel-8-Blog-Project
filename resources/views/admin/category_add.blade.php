                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_category_create') }}" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="keywords" class="form-control" id="inputEmail3" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="slug" class="form-control" id="inputEmail3" placeholder="Email">
                                        </div>
                                    </div>
